package com.mehisen.cards.controller;

import com.mehisen.cards.constants.CardConstants;
import com.mehisen.cards.dto.CardDTO;
import com.mehisen.cards.dto.ErrorResponseDTO;
import com.mehisen.cards.dto.ResponseDTO;
...
@Tag(
        name = "CRUD REST APIs for Cards in Mini Bank",
        description = "CRUD REST APIs in Mini Bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Mini Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
